...
public class WeaponsData : ItemData {
    ...
    public WeaponsData(int _id, string _name, ItemType _type, ItemQuality _quality, string _description, int _capaticy, string _iconName, string _atlasName, float _mpRecovery)
